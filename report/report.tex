...
\begin{document}
  ...
  \title{Linear Time Generation and Coloring of Simulated Wireless Sensor Networks with Random Geometric Graphs}
  \author{Luke Wood}
  \maketitle
  ...
  At the moment random geographic graphs are the state of the art method for simulating WSNs.
	This project usesRGGs as a way to gather valuable information about how wireless sensor networks will possibly function and communicate.
  ...
  The coloring algorithms also run in $O(V+E)$ which is linear time in graph theory.
  ...
  \begin{table}
    ...
    \end{adjustbox}
    \caption{Benchmark Data Generated}
  \end{table}
  ...
  \section{Reduction to Practice}
    ...
    In python, sets have amortized $O(n)$ runtime for all three of the aforementioned operations\cite{pythonwikiruntimes}.
