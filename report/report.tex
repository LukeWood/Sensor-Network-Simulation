...
\begin{document}
  ...
  \begin{table}
    ...
    \csvautotabular{../results/square/generation/benchmarks/data.csv}
  ...
  \begin{table}
    ...
    \csvautotabular{../results/disc/generation/benchmarks/data.csv}
  ...
  \begin{table}
    ...
    \csvautotabular{../results/sphere/generation/benchmarks/data.csv}
